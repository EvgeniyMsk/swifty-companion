...
class   IntraApi: OAuth2DataLoader {
    ...
    public init() {
        let oauth = OAuth2ClientCredentials(settings: [
            "client_id": "c6d1c17903561334d1374816cfc4854c844fbfdaa736088f3e1f59f8352070f3",
            "client_secret": "ed7aec39b16719e5e4bfd420412a9c201ba16adf9bd7884c28fa18e5ed28e89a",
    ...
    func    createUser(_ json: OAuth2JSON, newUser: User) -> Void {
        ...
        newUser.wallet = json["wallet"] as! Int
        newUser.evaluationPoints = json["correction_point"] as! Int
